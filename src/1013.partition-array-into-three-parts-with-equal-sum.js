...
var canThreePartsEqualSum = function(arr) {
  ...
  for (let i = 0; i < arr.length - 1; i++) {
    cnt += arr[i]
    if ((sign == 0 && cnt == sum) || (sign == 1 && cnt == 2 * sum)) {
      sign++
    }
  }
  return sign >= 2
